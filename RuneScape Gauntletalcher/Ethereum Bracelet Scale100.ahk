...
Gui, Add, Text, x100 y200 +BackgroundTrans, Ether Cost
Gui, Add, Text, x75 y225 +BackgroundTrans, Bracelet Cost
Gui, Add, Text, x37 y250 +BackgroundTrans, Nature Rune Cost
Gui, Font, S12 CBlack Bold, Verdana
Gui, Add, Edit, x200 y200 w75 h20 vEther,
Gui, Add, Edit, x200 y225 w75 h20 vBracelet,
Gui, Add, Edit, x200 y250 w75 h20 vNature,
...
gui, 2:add, text, x2 y47 w470 h48 vTextVar_Answer1 +BackgroundTrans, Bracelet Made : %NbrBracelet%
...
AlchAllBracelet()
{
	global CounterX	:= 2
	global CounterY := 1
	MouseMoveRandom(1301, 208, 15, 15)  ; Click magic tab
	RandomSleep(100,250)
	Click
	RandomSleep(100,250)
	Loop, 25
	{
		MouseMoveRandom(1274,353, 10, 10)  ; Click High Alch
		RandomSleep(100,250)
		Click
		RandomSleep(100,250)
		MouseMoveRandom(1179, 468, 10, 10)
		RandomSleep(100,250)
		Click
...
Bank()
{
	MouseMoveRandom(1203,210,10,10)		; click inventory
	RandomSleep(100,300)
	click
	RandomSleep(100,300)
	MouseMoveRandom(792, 133, 10, 10)    ;Click Booth
	RandomSleep(100,250)
	Click
	RandomSleep(750,1250)
	MouseMoveRandom(647, 123, 10, 10)	  ; Click ether
	RandomSleep(100,250)
	Click
	RandomSleep(100,250)
	MouseMoveRandom(694, 120, 10, 10)	  ; Right click bracelet
	RandomSleep(100,250)
	Click right
	RandomSleep(100,250)
	MouseMove, 0, 70, 1, R
	...
	Click
	RandomSleep(100,250)
	MouseMoveRandom(1045, 46, 3, 3)      ; Close bank
	RandomSleep(100,250)
	Click
...
{
	global InventoryX	:=	[1138, 1180, 1220, 1263]
	global InventoryY	:=	[252, 290, 326, 360, 397, 432, 470]
